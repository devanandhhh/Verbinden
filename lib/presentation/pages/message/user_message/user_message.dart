...
class UserMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            Expanded(child: BlocBuilder<ChatHistoryBloc, ChatHistoryState>(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Card(
                      margin:
                          const EdgeInsets.only(left: 6, bottom: 10, right: 4),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (messageController.text.isNotEmpty) {
                        context.read<ChatHistoryBloc>().add(ChatSentEvent(
                            userId: userId, message: messageController.text));
